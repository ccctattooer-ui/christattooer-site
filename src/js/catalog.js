...
(function () {
  ...
  // flash close-up: one click on a drawing opens it big, one click on the big one puts it away.
  ...
  if (fz) {
    ...
    // Click the drawing again and it goes away. No zoom step in between: the way out of a picture
    // should be the same click that brought it up.
    fimg.addEventListener('click', () => fz.close());
